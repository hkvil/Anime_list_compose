...
data class Waifu(
    ...
    @DrawableRes val waifuPhoto: Int,
    @DrawableRes val waifuVoiceActorPhoto: Int
) : Parcelable


@Composable
fun getWaifuByName(name:String):Waifu?{
    val waifuList = getWaifuArrayData()
...
@Composable
fun getWaifuArrayData(): ArrayList<Waifu> {
    val waifuArray = ArrayList<Waifu>()
    val waifuName = stringArrayResource(id = R.array.data_name)
    val waifuVoiceActor = stringArrayResource(R.array.data_voiced_by)
    val waifuAge = stringArrayResource(R.array.data_age)
    val waifuAnimeTitle = stringArrayResource(R.array.data_anime_title)
    val waifuBirthday = stringArrayResource(R.array.data_birth_day)

    val waifuPhoto = arrayListOf(
        R.drawable.rem,
        R.drawable.fubuki,
        R.drawable.hinata_hyuga,
        R.drawable.makima,
        R.drawable.yor_forger,
        R.drawable.kurisu_makise,
        R.drawable.erza_scarlet,
        R.drawable.mikasa_ackerman,
        R.drawable.artoria_pendragon,
        R.drawable.asuna_yuki
    )
    val waifuVoiceActorPhoto = arrayListOf(
        R.drawable.inori_minase,
        R.drawable.saori_hayami,
        R.drawable.nana_mizuki,
        R.drawable.tomori_kusunoki,
        R.drawable.saori_hayami,
        R.drawable.asami_imai,
        R.drawable.sayaka_ohara,
        R.drawable.yui_ishikawa,
        R.drawable.ayako_kuwasumi,
        R.drawable.haruka_tomatsu
    )
